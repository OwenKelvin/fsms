...
@Component({
	...
	imports: [BrnSelectTrigger, NgIcon, HlmIcon, HlmFormFieldControlDirective],
	providers: [provideIcons({ lucideChevronDown })],
	hostDirectives: [HlmFormFieldControlDirective],
	changeDetection: ChangeDetectionStrategy.OnPush,
	template: `
		<button [class]="_computedClass()" #button brnSelectTrigger type="button" [attr.data-size]="size()">
			<ng-content />
			@if (_icon()) {
