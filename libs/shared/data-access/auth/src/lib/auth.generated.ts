...
export type ISignInWithGoogleMutation = { signInWithGoogle?: { accessToken: string, refreshToken: string, refreshTokenKey: string, user?: { id: string, firstName: string, lastName: string, email: string } | null } | null };
...
export type ISignupGoogleUserMutation = { signupGoogleUser?: { accessToken: string, refreshToken: string, refreshTokenKey: string, user?: { id: string, firstName: string, lastName: string, email: string } | null } | null };
...
export type IContinueWithGoogleMutation = { continueWithGoogle?: { accessToken: string, refreshToken: string, refreshTokenKey: string, user?: { id: string, firstName: string, lastName: string, email: string } | null } | null };
...
export type ILoginWithTokenMutation = { loginWithToken?: { accessToken: string, refreshToken: string, refreshTokenKey: string, user?: { id: string, firstName: string, lastName: string, email: string } | null } | null };
...
export type ILoginWithResetPasswordTokenMutation = { loginWithResetPasswordToken?: { accessToken: string, refreshToken: string, refreshTokenKey: string, user?: { id: string, firstName: string, lastName: string, email: string } | null } | null };
...
export type ILoginWithPasswordMutation = { loginWithPassword?: { accessToken: string, refreshToken: string, refreshTokenKey: string, user?: { id: string, firstName: string, lastName: string, email: string } | null } | null };
...
export type ISendPasswordResetLinkEmailMutation = { sendPasswordResetLinkEmail?: { success: boolean, message: string } | null };

export type ISendVerificationLinkEmailMutationVariables = Types.Exact<{ [key: string]: never; }>;


export type ISendVerificationLinkEmailMutation = { sendVerificationLinkEmail?: { success: boolean, message: string } | null };
...
export type IVerifyEmailMutation = { verifyEmail?: { success: boolean, message: string } | null };
...
export type ISendPasswordResetOtpEmailMutation = { sendPasswordResetOtpEmail?: { success: boolean, message: string } | null };
...
export type IValidateOtpMutation = { validateOtp?: { accessToken: string, refreshToken: string, refreshTokenKey: string, user?: { id: string, firstName: string, lastName: string, email: string } | null } | null };
...
export type IChangePasswordMutation = { changePassword?: { success: boolean, message: string } | null };
...
export type IChangePasswordUsingResetTokenMutation = { changePasswordUsingResetToken?: { accessToken: string, refreshToken: string, refreshTokenKey: string, user?: { id: string, firstName: string, lastName: string, email: string } | null } | null };
...
export type IValidatePasswordResetTokenMutation = { validatePasswordResetToken?: { user?: { id: string, firstName: string, lastName: string, email: string } | null } | null };
