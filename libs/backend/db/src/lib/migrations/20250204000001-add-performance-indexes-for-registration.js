...
module.exports = {
  async up(queryInterface) {
    ...
    await queryInterface.addIndex(
      ...
      ['registration_id', 'verification_status'],
      {
  ...
  async down(queryInterface) {
    ...
    await queryInterface.removeIndex(
      'registration_status_history',
      'idx_registration_status_history_reg_changed',
    );
    await queryInterface.removeIndex(
      'registration_documents',
      'idx_registration_documents_type_verification',
    );
    await queryInterface.removeIndex(
      'registration_documents',
      'idx_registration_documents_reg_verification',
    );
    await queryInterface.removeIndex(
      'registration_records',
      'idx_registration_records_institution_admin',
    );
    await queryInterface.removeIndex('users', 'idx_users_username');
    await queryInterface.removeIndex('users', 'idx_users_email');
    await queryInterface.removeIndex(
      'registration_records',
      'idx_registration_records_created_at',
    );
    await queryInterface.removeIndex(
      'registration_records',
      'idx_registration_records_status_completed_at',
    );
    await queryInterface.removeIndex(
      'registration_records',
      'idx_registration_records_status_created_at',
    );
  },
};
