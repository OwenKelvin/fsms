...
import { PermissionModel, RoleModel, RoleUserModel, UserModel } from './models';
...
describe('DbModule', () => {
  it('should configure Sequelize with proper options and include all models', () => {
    ...
    console.log(DbModule.name); // trigger module initialization
    ...
    expect(mockedSequelizeModule).toHaveBeenCalledWith(
