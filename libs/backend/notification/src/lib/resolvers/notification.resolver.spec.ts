...
import { NotificationBackendService } from '@fsms/backend/notification-backend-service';
...
describe('NotificationResolver', () => {
  ...
  let notificationService: NotificationBackendService;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        {
          provide: NotificationBackendService,
    ...
    notificationService = module.get<NotificationBackendService>(
