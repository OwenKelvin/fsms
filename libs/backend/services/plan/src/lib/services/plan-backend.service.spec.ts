...
import { PlanBackendService } from './plan-backend.service';
import {
  QueryOperatorEnum,
  PlanModel,
  SortByDirectionEnum,
...
describe('PlanBackendService', () => {
  let service: PlanBackendService;
  ...
  beforeEach(async () => {
    ...
    service = module.get<PlanBackendService>(PlanBackendService);
  });
