...
describe('InstructionBackendService', () => {
  let service: InstructionBackendService;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        {
          provide: getModelToken(InstructionModel),
          useValue: modelRepositoryMock,
        },
      ],
    }).compile();

    service = module.get<InstructionBackendService>(InstructionBackendService);
  });
