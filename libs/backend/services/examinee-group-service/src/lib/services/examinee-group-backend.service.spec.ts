...
describe('ExamineeGroupBackendService', () => {
  let service: ExamineeGroupBackendService;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        {
          provide: getModelToken(ExamineeGroupModel),
          useValue: modelRepositoryMock,
        },
        {
          provide: getModelToken(ExamineeModel),
          useValue: modelRepositoryMock,
        },
      ],
    }).compile();

    service = module.get<ExamineeGroupBackendService>(
      ExamineeGroupBackendService,
    );
  });
