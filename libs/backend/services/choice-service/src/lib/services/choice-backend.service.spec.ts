...
import { ChoiceBackendService } from './choice-backend.service';
import {
  QueryOperatorEnum,
  ChoiceModel,
  SortByDirectionEnum,
...
describe('ChoiceBackendService', () => {
  let service: ChoiceBackendService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ChoiceBackendService,
        {
    ...
    service = module.get<ChoiceBackendService>(ChoiceBackendService);
  });
