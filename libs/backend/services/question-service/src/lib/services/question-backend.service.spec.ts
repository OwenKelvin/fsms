...
import { QuestionBackendService } from './question-backend.service';
import {
  ChoiceModel,
  QueryOperatorEnum,
  QuestionModel,
...
describe('QuestionBackendService', () => {
  let service: QuestionBackendService;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        {
          provide: getModelToken(QuestionModel),
          useValue: modelRepositoryMock,
        },
        {
          provide: getModelToken(ChoiceModel),
          useValue: modelRepositoryMock,
        },
        {
          provide: getModelToken(QuestionTagModel),
          useValue: modelRepositoryMock,
        },
        {
    ...
    service = module.get<QuestionBackendService>(QuestionBackendService);
  });
