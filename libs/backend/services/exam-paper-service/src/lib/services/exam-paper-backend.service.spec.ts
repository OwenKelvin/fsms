...
describe('ExamPaperBackendService', () => {
  let service: ExamPaperBackendService;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        {
          provide: getModelToken(ExamPaperModel),
          useValue: modelRepositoryMock,
        },
        {
          provide: getModelToken(ConfigExamPaperModel),
          useValue: modelRepositoryMock,
        },
        {
          provide: getModelToken(ExamPaperTagModel),
          useValue: modelRepositoryMock,
        },
        {
    ...
    service = module.get<ExamPaperBackendService>(ExamPaperBackendService);
  });
