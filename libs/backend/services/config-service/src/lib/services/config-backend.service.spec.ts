...
import { ConfigBackendService } from './config-backend.service';
import {
  QueryOperatorEnum,
  ConfigModel,
  SortByDirectionEnum,
...
describe('ConfigBackendService', () => {
  let service: ConfigBackendService;
  ...
  beforeEach(async () => {
    ...
    service = module.get<ConfigBackendService>(ConfigBackendService);
  });
